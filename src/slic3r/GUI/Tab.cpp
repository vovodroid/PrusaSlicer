...
void TabPrint::build()
{
    ...
    auto page = add_options_page(L("Layers and perimeters"), "layers");
        ...
        optgroup->append_single_option_line("perimeter_coasting");
        optgroup->append_single_option_line("perimeter_wipe_seam");
    ...
    page = add_options_page(L("Speed"), "time");
        ...
        optgroup->append_single_option_line("first_layer_solid_speed");
    ...
    page = add_options_page(L("Advanced"), "wrench");
        ...
        optgroup->append_single_option_line("first_layer_solid_flow_ratio");
