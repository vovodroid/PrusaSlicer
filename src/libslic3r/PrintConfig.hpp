...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                 internal_first_on_overhangs))
    ...
    ((ConfigOptionInt,                  overhangs_detection))
    ...
    ((ConfigOptionBool,                 reverse_external_perimeters))
    ((ConfigOptionBool,                 reverse_perimeters))
    ((ConfigOptionBool,                 reverse_infill))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloatOrPercent,     first_layer_solid_speed))
