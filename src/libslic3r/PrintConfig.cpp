...
static const t_config_enum_values s_keys_map_InfillPattern {
    ...
    { "alignedmonotonic",   ipAlignedMonotonic },
    { "grid",               ipGrid },
...
void PrintConfigDef::init_fff_params()
{
    ...
    def->set_enum<InfillPattern>({
        ...
        { "alignedmonotonic",   L("Aligned Monotonic") },
    ...
    def = this->add("fan_speedup_time", coFloats);
    ...
    def = this->add("first_layer_solid_speed", coFloatOrPercent);
